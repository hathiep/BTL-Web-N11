...
<!--                <svg viewBox="0 0 192 65" class="header__logo-img">
                ...
                <img alt="Thê giới phụ kiện" src="imgs/logo.png" class="header__logo-img">
              </a>
            </div>
                ...
                <div class="header__search-history">
                  ...
                  <ul class="header__search-history-list">
                    <li class="header__search-history-item">
                      <a href="https://twitter.com/campus2k2">Sạc Iphone</a>
                    </li>
                    <li class="header__search-history-item">
                      <a href="">Cam hành trình</a>
                    </li>
                    <li class="header__search-history-item">
                      <a href="">ốp lưng</a>
                    </li>
